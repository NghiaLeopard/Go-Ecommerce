...
func InitServer(sqlcDB *db.Queries, config2 config.Config, redis2 *redis.Client) (*api.ServerHTTP, error) {
	...
	serverHTTP := api.NewServerHTTP(config2, middlewareMiddleware, iHandlerAuth, iHandlerProduct, iHandlerCity, iHandlerDelivery, iHandlerPayment, iHandlerRole, iHandlerProductType)
