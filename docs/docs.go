...
const docTemplate = `{
    ...
    "paths": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_NghiaLeopard_Go-Ecommerce-Backend_internal_api_handler_request.CreateUser"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/users/delete-many": {
            "delete": {
                ...
                "parameters": [
                    {
                        "description": "DeleteMany User",
                        "name": "tags",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_NghiaLeopard_Go-Ecommerce-Backend_internal_api_handler_request.DeleteManyUser"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Delete many User success",
                        "schema": {
                            "type": "string"
                        }
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_NghiaLeopard_Go-Ecommerce-Backend_internal_api_handler_request.GetBodyUpdateUser"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "github_com_NghiaLeopard_Go-Ecommerce-Backend_internal_api_handler_request.CreateUser": {
            "type": "object",
            "required": [
                "address",
                "city",
        ...
        "github_com_NghiaLeopard_Go-Ecommerce-Backend_internal_api_handler_request.DeleteManyUser": {
            "type": "object",
            "required": [
                "userIds"
            ],
        ...
        "github_com_NghiaLeopard_Go-Ecommerce-Backend_internal_api_handler_request.GetBodyUpdateUser": {
            "type": "object",
            "required": [
                "address",
                "avatar",
